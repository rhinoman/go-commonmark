...
2.) Make sure the directory you install libcmark to is somewhere that your system will find it at runtime (/usr/lib usually should work).  Or you can be lazy and add its location to your LD_LIBRARY_PATH. 
...
For now, this wrapper does indeed work with CommonMark master/31bca912bc :)
